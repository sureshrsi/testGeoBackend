...
const getGridByCircleGid = async (req,res) =>{
  try{
const { query } = req.query;
console.log('Search query name:', query);
const SelectProjectInfo = `SELECT s.gid,s.grid_no,ST_AsText(ST_Transform(ST_Envelope(s.geom), 4326)) AS extent_latlong
FROM namsai_grid_10k s
...
module.exports = { getGridByCircleGid}    